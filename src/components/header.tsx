  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? 'bg-background/80 backdrop-blur-md shadow-lg shadow-accent/10 border-border' : 'bg-transparent border-transparent'
      )}
    >
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          <a href="https://wa.me/5547933801637" target="_blank" rel="noopener noreferrer">
            <Button size="sm" className="bg-accent text-white font-bold hover:bg-accent/90 flex items-center gap-2">
