              ...
              <Card key={project.id} className="group overflow-hidden border-border bg-card shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-accent/20 hover:-translate-y-2 hover:border-accent/40">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p><span className="text-accent font-semibold">Solução:</span> <span className="text-muted-foreground line-clamp-2">{project.solution}</span></p>
                  </div>
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-accent text-sm font-medium hover:underline mt-2">
